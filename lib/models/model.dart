...
//
//     final charaterModel = charaterModelFromJson(jsonString);

import 'dart:convert';

CharacterModel charaterModelFromJson(String str) => CharacterModel.fromJson(json.decode(str));

String charaterModelToJson(CharacterModel data) => json.encode(data.toJson());
